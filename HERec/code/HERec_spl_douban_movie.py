...
class HNERec_douban_movie:
    ...
    def load_embedding(self, metapaths, num):
        ...
        for metapath in metapaths:
            sourcefile = '../data/Douban_Movie/embeddings/' + metapath
            #print sourcefile
...
if __name__ == "__main__":
    ...
    user_metapaths = ['umu', 'umdmu', 'umamu', 'umtmu']
    item_metapaths = ['mum', 'mam', 'mdm', 'mtm']
    ...
    trainfile = '../data/Douban_Movie/um_'+str(train_rate)+'.train'
    testfile =  '../data/Douban_Movie/um_'+str(train_rate)+'.test'
    steps = 100
    delta = 0.02
    beta_e = 0.1
    beta_h = 0.1
    ...
    HNERec_douban_movie(unum, inum, ratedim, userdim, itemdim, user_metapaths, item_metapaths, trainfile, testfile, steps, delta, beta_e, beta_h, beta_p, beta_w, beta_b, reg_u, reg_v)
